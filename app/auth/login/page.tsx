...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const tenantSlug = data.user.slug; 

      if (role === 'ADMIN') {
        router.push(`/${tenantSlug}/dashboard/admin`);
      } else if (role === 'PM') {
        router.push(`/${tenantSlug}/dashboard/pm`);
      } else if (role === 'DEVELOPER') {
        router.push(`/${tenantSlug}/dashboard/developer`);
      } else if (role === 'ANALYST') {
        router.push(`/${tenantSlug}/dashboard/analyst`);
      }
